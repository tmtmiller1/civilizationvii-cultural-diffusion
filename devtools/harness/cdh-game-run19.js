// cdh-game-run19.js - game scope, deployed as ui/cdh-game.js. Cultural Diffusion harness run 18 (dev only).
//
...
async function run() {
  ...
  emit(`S0 run19 turn=${safe(() => Game.turn)} local=${local} modPass=${CONFIG.diffusionEnabled} `
